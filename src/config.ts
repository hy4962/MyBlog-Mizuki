...
export const siteConfig: SiteConfig = {
	...
	banner: {
		...
		src: {
			desktop: [
				"/assets/desktop-banner/kirino.webp",
				"/assets/desktop-banner/three.webp",
...
export const profileConfig: ProfileConfig = {
	avatar: "assets/images/xiaoyuan.avif", // 相对于 /src 目录。如果以 '/' 开头，则相对于 /public 目录		这是个人资料组件的头像图片路径，支持本地图片和外部链接。建议使用方形图片以获得最佳显示效果。
	name: "鹤渊", // 个人资料组件的名称文本
	bio: "写来自己看的...", // 个人资料组件的简介文本
	typewriter: {
